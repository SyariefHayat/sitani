                ...
                <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                        ...
                        >
                            ...
                            <span className="hidden sm:inline">Rp 15.320.000</span>
                            <span className="sm:hidden">15.3jt</span>
                    ...
                    <DropdownMenuContent align="end" className="w-72">
                        ...
                        <div className="px-2 py-3 space-y-3">
                            <div className="flex items-center justify-between">
                                ...
                                <span className="text-sm font-bold text-[#206536]">Rp 15.320.000</span>
                            </div>
                            <div className="flex items-center justify-between">
                                <span className="text-sm text-muted-foreground">Saldo Tersedia</span>
                                <span className="text-sm font-semibold">Rp 9.850.000</span>
                            </div>
                            <div className="flex items-center justify-between">
                                <span className="text-sm text-muted-foreground">Menunggu Pencairan</span>
                                <span className="text-sm font-semibold text-amber-600">Rp 5.470.000</span>
                            </div>
                        </div>
                        ...
                        <DropdownMenuItem asChild className="cursor-pointer">
                            <Link href="/logistik/dompet" className="flex items-center gap-2 text-sm">
