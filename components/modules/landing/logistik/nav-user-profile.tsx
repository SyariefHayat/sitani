...
import { Bell, ChevronDown, LogOut, User, Truck, Settings, Wallet } from "lucide-react"
            ...
            <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-80">
                    ...
                    <DropdownMenuItem className="flex flex-col items-start gap-1 py-3 cursor-pointer">
                        <span className="text-sm font-semibold">Order pengiriman baru masuk 🚛</span>
                        <span className="text-xs text-muted-foreground">5 menit yang lalu</span>
                    </DropdownMenuItem>

                    <DropdownMenuItem className="flex flex-col items-start gap-1 py-3 cursor-pointer">
                        <span className="text-sm font-semibold">Pickup dijadwalkan untuk besok</span>
                        <span className="text-xs text-muted-foreground">30 menit yang lalu</span>
                    </DropdownMenuItem>

                    <DropdownMenuItem className="flex flex-col items-start gap-1 py-3 cursor-pointer">
                        <span className="text-sm font-semibold">Armada Truk-05 selesai maintenance</span>
                ...
                <DropdownMenuTrigger asChild>
                    <button className="flex items-center gap-3 hover:opacity-80 transition-opacity cursor-pointer">
                        <Avatar className="ring-2 ring-white/40 ring-offset-2 ring-offset-[#206536]">
                            ...
                            <AvatarFallback className="bg-white/20 text-white font-bold">BU</AvatarFallback>
                        </Avatar>
                        <div className="hidden sm:flex flex-col items-start">
                            <p className="text-white text-sm font-semibold leading-tight">Budi</p>
                            <p className="text-white/60 text-xs leading-tight">Logistik</p>
                        </div>
                ...
                <DropdownMenuContent align="end" className="w-56 rounded-xl shadow-xl border border-gray-200">
                    ...
                    <DropdownMenuLabel className="py-3">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <p className="text-sm font-semibold text-gray-800">Budi</p>
                                <p className="text-xs text-gray-500 font-normal">budi@sitani.id</p>
                            </div>
                        </div>
                    </DropdownMenuLabel>
                    <DropdownMenuSeparator />
                    ...
                    <DropdownMenuItem asChild className="cursor-pointer gap-2.5 py-2.5">
                        <Link href="/logistik/profil">
                            <User className="w-4 h-4" />
                            Profil Saya
                        </Link>
                    </DropdownMenuItem>
                    <DropdownMenuItem asChild className="cursor-pointer gap-2.5 py-2.5">
                        <Link href="/logistik/armada">
                            <Truck className="w-4 h-4" />
                            Armada Saya
                        </Link>
                    </DropdownMenuItem>
                    <DropdownMenuItem asChild className="cursor-pointer gap-2.5 py-2.5">
                        <Link href="/logistik/dompet">
                            <Wallet className="w-4 h-4" />
                            Dompet
                        </Link>
                    </DropdownMenuItem>
                    <DropdownMenuItem asChild className="cursor-pointer gap-2.5 py-2.5">
                        <Link href="/logistik/pengaturan">
