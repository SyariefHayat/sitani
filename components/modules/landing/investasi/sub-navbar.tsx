...
import { INVESTASI_MENU } from "@/lib/constants"
import { ChevronDown, Wallet, ArrowUpRight, ArrowDownLeft, Receipt } from "lucide-react"
import {
    DropdownMenu,
    DropdownMenuContent,
    DropdownMenuItem,
                ...
                <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                        ...
                        >
                            ...
                            <span className="hidden sm:inline">Rp 12.500.000</span>
                            <span className="sm:hidden">12.5jt</span>
                    ...
                    <DropdownMenuContent align="end" className="w-72">
                        ...
                        <div className="px-2 py-3 space-y-3">
                            <div className="flex items-center justify-between">
                                ...
                                <span className="text-sm font-bold text-[#206536]">Rp 12.500.000</span>
                            </div>
                            <div className="flex items-center justify-between">
                                <span className="text-sm text-muted-foreground">Saldo Tersedia</span>
                                <span className="text-sm font-semibold">Rp 8.200.000</span>
                            </div>
                            <div className="flex items-center justify-between">
                                <span className="text-sm text-muted-foreground">Saldo Mengendap</span>
                                <span className="text-sm font-semibold text-amber-600">Rp 4.300.000</span>
                            </div>
                        </div>
                        ...
                        <DropdownMenuItem asChild className="cursor-pointer">
                            <Link href="/investasi/riwayat" className="flex items-center gap-2 text-sm">
