...
import { Bell, ChevronDown, LogOut, User, Briefcase, Settings, Wallet } from "lucide-react"
            ...
            <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-56 rounded-xl shadow-xl border border-gray-200">
                    ...
                    <DropdownMenuItem asChild className="cursor-pointer gap-2.5 py-2.5">
                        <Link href="/investasi/profil">
                            <User className="w-4 h-4" />
                            Profil Saya
                        </Link>
                    </DropdownMenuItem>
                    <DropdownMenuItem asChild className="cursor-pointer gap-2.5 py-2.5">
                        <Link href="/investasi/portofolio">
                            <Briefcase className="w-4 h-4" />
                            Portofolio Saya
                        </Link>
                    </DropdownMenuItem>
                    <DropdownMenuItem asChild className="cursor-pointer gap-2.5 py-2.5">
                        <Link href="/investasi/dompet">
                            <Wallet className="w-4 h-4" />
                            Dompet
                        </Link>
                    </DropdownMenuItem>
                    <DropdownMenuItem asChild className="cursor-pointer gap-2.5 py-2.5">
                        <Link href="/investasi/pengaturan">
