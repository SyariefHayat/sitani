...
const investorSchema = z
  .object({
    ...
    tipeInvestor: z.string().min(1, "Tipe investor wajib dipilih"),
    sumberDana: z.string().min(1, "Sumber dana wajib dipilih"),
    pengalaman: z.string().min(1, "Pengalaman investasi wajib dipilih"),
  })
    ...
    try {
      const res = await fetch("/api/auth/register", {
        ...
        body: JSON.stringify({
          ...
          // profile data investor
          tipeInvestor: values.tipeInvestor,
