...
const pesertaSchema = z
  .object({
    ...
    minat: z.string().min(1, "Minat pelatihan wajib dipilih"),
  })
...
const RegisterPesertaForm = () => {
  ...
  const onSubmit = async (values: PesertaFormValues) => {
    try {
